...
![Filament Additional Information](https://raw.githubusercontent.com/jeffersongoncalves/filament-additional-information/2.x/art/jeffersongoncalves-filament-additional-information.png)
...
```bash
composer require jeffersongoncalves/filament-additional-information:^2.0
```
